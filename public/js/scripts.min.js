...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        $(".sidebar-off").removeClass("sidebar-on")
    }), $(".sidebar-off").click(function (t) {
        t.stopPropagation()
    }), $("#sidebar-btn").on("click", function (t) {
        t.stopPropagation(), t.preventDefault(), $(".sidebar-off").toggleClass("sidebar-on")
    });
    ...
    var r = $("#GreenKnobs, #YellowKnobs, #RedKnobs, #LightBlueKnobs, #BlueKnobs");
    $(".light-blue").on("click", function () {
        return $("#colors").attr("href", "assets/css/themes/light-blue.css"), r.hide(), $("#LightBlueKnobs").show(), !1
    }), $(".blue").on("click", function () {
        return $("#colors").attr("href", "assets/css/themes/blue.css"), r.hide(), $("#BlueKnobs").show(), !1
    }), $(".red").on("click", function () {
        return $("#colors").attr("href", "assets/css/themes/red.css"), r.hide(), $("#RedKnobs").show(), !1
    }), $(".yellow").on("click", function () {
        return $("#colors").attr("href", "assets/css/themes/yellow.css"), r.hide(), $("#YellowKnobs").show(), !1
    }), $(".green").on("click", function () {
        return $("#colors").attr("href", "assets/css/themes/green.css"), r.hide(), $("#GreenKnobs").show(), !1
    }), $(window).scroll(function () {
    ...
    var h = $("#mb-slideshow").slippry({
        slideWrapper: '<div class="frame sy-slides-wrap" />',
        slippryWrapper: '<div class="slippry_box thumbnails" />',
        transition: "horizontal",
        pager: !1,
        auto: !0,
        onSlideBefore: function (t, s, i) {
            $(".thumbs a img").removeClass("active"), $("img", $(".thumbs a")[i]).addClass("active")
        }
    });
    $(".thumbs a").click(function () {
        return h.goToSlide($(this).data("slide")), !1
        ...
        useCSS: !0,
        pause: 5e3
    }), $(".sticker").sticky({topSpacing: 0}), $(".lbKnob").knob({
        fgColor: "#1eb9c1",
        min: 0,
        max: 100,
        step: 5,
        ...
        draw: function () {
            if ("tron" == this.$.data("skin")) {
                var t, s = this.angle(this.cv), i = this.startAngle, e = this.startAngle, o = e + s, r = 1;
